...
def load_dailyDialogs():
    ...
    data_rez = []
    emotion_rez = []
    path = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/ijcnlp_dailydialog/'
...
def load_crowdFlower():
    file = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/crowdflower/text_emotion.csv'
...
def load_TEC():
    data = []
    emotions = []
    folder = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/TEC/'
...
def load_tales_emotions():
    ...
    emotions = {}
    author = "grimms"
    folder = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/tales-emotions/Grimms/emmood/'
    ...
    author = "HCAndersen"
    folder = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/tales-emotions/HCAndersen/emmood/'
    for file in os.listdir(folder):
        f_tmp = open(folder + file, 'r').read().split('\n')
        for f in f_tmp:
            f = f.split('\t')
    ...
    author = "Potter"
    folder = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/tales-emotions/Potter/emmood/'
    for file in os.listdir(folder):
        f_tmp = open(folder + file, 'r').read().split('\n')
        for f in f_tmp:
            f = f.split('\t')
...
def load_ISEAR():
    folder = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/isear/'
...
def load_emoInt():
    data = {}
    emotions = {}
    folder = "/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/EmoInt/"
    for file in os.listdir(folder):
...
def load_electorialTweets():
    data = {}
    emotions = {}
    folder = '/content/drive/My Drive/semantic_emotion_recognition/SENN_datasets/electoraltweets/Annotated-US2012-Election-Tweets/'
